...
-   The merged dataset Mr_and_Pro has 641 observations and 15 variables,
    they are dumpster, month, year, date, weight(tons), volume(cubic
    yards), plastic_bottles, polystyrene, cigarette_butts,
...
-   The `snp` dataset has has 787observations with 3 variables: year,
...
-   First, using the left join to merge the snp dataset into pols_month,
    the new dataset has 822observations and 11variables,they are mon,
    gov_gop, sen_gop, rep_gop, gov_dem, sen_dem, rep_dem, year, month,
    president, close. The range of year is \[1947, 2015\]. Then, merging
    the `unemployment` dataset to `pols_snp`, It contains
    822observations and 12 variables:mon, gov_gop, sen_gop, rep_gop,
    gov_dem, sen_dem, rep_dem, year, month, president, close,
    unemployment_rate. The range of year is \[1947, 2015\].
